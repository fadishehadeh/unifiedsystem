    ...
    <div className="min-h-screen bg-gradient-to-l from-[#1D4381] to-[#1B458A]" style={{ fontFamily: 'Lusail, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Login Card */}
          <Card className="bg-white shadow-2xl animate-slide-in-left hover:shadow-3xl transition-all duration-300">
          ...
          {/* MOCI Logo Card */}
          <div className="bg-[#345D9B]/30 backdrop-blur-sm rounded-lg p-12 flex flex-col items-center justify-center text-white animate-slide-in-right hover:bg-[#345D9B]/40 transition-all duration-300">
            <div className="w-48 h-48 bg-white/20 rounded-full flex items-center justify-center mb-6 hover:scale-105 transition-transform duration-300">
              {/* MOCI Emblem */}
              <img
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              <div className="flex justify-between items-center mb-8">
                <button className="text-[#345D9B] hover:underline flex items-center gap-2 transition-all hover:gap-3">
                ...
                {services.map((service, index) => (
                  ...
                  >
                    <CardContent className="p-6 flex flex-col items-end gap-4 relative z-10">
                      ...
                      {/* Hover Button */}
                      <div className={`absolute inset-0 bg-gradient-to-t from-[#345D9B]/95 to-[#345D9B]/80 flex items-center justify-center transition-all duration-300 ${
                        hoveredCard === index ? 'opacity-100' : 'opacity-0'
                      }`}>
                        <Button className="bg-white text-[#345D9B] hover:bg-gray-100 font-bold px-6 py-3 rounded-full shadow-lg transform transition-all duration-300 hover:scale-110">
                          زيارة الخدمة
                        </Button>
                      </div>
                    </CardContent>
      ...
      <footer className="bg-[#345D9B] text-white py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-6">
            ...
            <div className="flex flex-wrap justify-center md:justify-end gap-8 text-white">
              ...
              <div className="text-center">
                ...
                <div className="flex items-center gap-2 bg-white/20 rounded-full px-4 py-2 hover:bg-white/30 transition-all">
              ...
              <div className="text-center">
                ...
                <a
                  ...
                  className="flex items-center gap-2 bg-white/20 rounded-full px-4 py-2 hover:bg-white/30 transition-all"
                >
          ...
          <div className="flex justify-center gap-4 mb-6">
            <a href="#" className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-all hover:scale-110">
          ...
          <div className="border-t border-white/20 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <div className="flex gap-6">
              <a href="#" className="hover:underline transition-all">المساعدة</a>
              <a href="#" className="hover:underline transition-all">سياسة الخصوصية</a>
            </div>
            <div className="text-center">
